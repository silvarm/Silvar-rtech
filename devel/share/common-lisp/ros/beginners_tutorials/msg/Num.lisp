...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginners_tutorials-msg:<Num> is deprecated: use beginners_tutorials-msg:Num instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginners_tutorials-msg:sum-val is deprecated.  Use beginners_tutorials-msg:sum instead.")
  (sum m))
